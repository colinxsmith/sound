...
alias kiaweeks='(a=$(date +%s);b=$(date +%s --date="2025/06/25");echo  $((($a-$b)/3600/24/7)) weeks)'
alias bitaweeks='(a=$(date +%s);b=$(date +%s --date="2026/01/31");echo  $((($a-$b)/3600/24/7)) weeks)'
alias bita1weeks='(a=$(date +%s);b=$(date +%s --date="1986/01/08");echo  $((($a-$b)/3600/24/7)) weeks)'
...
alias jazzfm='mplayer -ao pulse http://edge-baueral-01-gos2.sharp-stream.com/jazzhigh.aac?aw_0_1st.skey=1762640925'
